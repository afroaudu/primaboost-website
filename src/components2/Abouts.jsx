  ...
  return (
    <div>
       ...
       < div className='bg-gradient-to-r from-black px-20 py-60'>
        ...
        <h1 className="text-5xl  text-yellow-500 mb-9">About</h1>
          <p className='text-white'>Primaboost is a software and web development firm based in Lagos, Nigeria, that creates dedicated teams with expertise in JavaScript, Node.js, React, AWS, Azure, and Serverless.
          <br></br>
